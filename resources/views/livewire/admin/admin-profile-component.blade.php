            ...
            <div class="content-wrapper">
                ...
                <section id="extended">
                    ...
                    <div class="col-12 col-sm-8 col-md-6 col-lg-6 mx-auto ">
                        <div class="card mt-5 gradient-border">
                        ...
                        <div class="card-body text-center  shadow">
                            ...
                            <p class="card-text border-bottom pb-2 mb-3 shadow"> <i class="fa fa-users-cog"></i> Role : Admin</p>




                                <a  class="btn-hover color-hover px-4 py-2 " href="{{url('admin/Update_Profile')}}">
