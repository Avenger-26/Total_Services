...
<div data-active-color="white" data-background-color="black"
    ...
    <div class="sidebar-header">
        <div class="logo clearfix"><a href="/" class="logo-text float-left">
                <div class="logo-img "><img src="<?php echo e(asset('images/d-logo.png')); ?>" width="30" alt=""></div>
    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true"
                ...
                <li class=" nav-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><i
                            class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo e(route('admin.profile')); ?>"><i class="ft-user mr-2"></i><span
                            data-i18n="" class="menu-title">
                            Profile</span></a>
                </li>

                <li class=" nav-item"><a href="<?php echo e(route('admin.service_provider')); ?>"><i
                            class="
                fa fa-users mr-2"></i><span data-i18n=""
                            class="menu-title">Service Provider</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo e(route('admin.users')); ?>"><i class="ft-users mr-2"></i><span
                            data-i18n="" class="menu-title">
                            Users</span></a></li>
                <li class=" nav-item"><a href="<?php echo e(route('admin.service_categories')); ?>"><i
                            class="
                ft-briefcase mr-2"></i><span data-i18n=""
                            class="menu-title">Service Categories</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo e(route('admin.all_services')); ?>"><i
                            class="
                    ft-grid mr-2"></i><span data-i18n="" class="menu-title">All
                            Services
                        </span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo e(route('admin.contacts')); ?>">

                        <i class="fa fa-envelope-open"></i><span data-i18n="" class="menu-title">All
                            Queries</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo e(route('admin.changepassword')); ?>">
        ...
        <?php if(auth()->guard()->check()): ?>
            <?php if(Auth::user()->u_type === 'ADM'): ?>
                <li class="login-form"><a href="#" title="Register">My Account( Admin )</a>
                    <ul class="drop-down one-column hover-fade">
                        <li><a href="<?php echo e(route('admin.dashboard')); ?>">Dasboard</a></li>
            ...
            <?php elseif(Auth::user()->u_type === 'SPV'): ?>
                <li class="login-form"><a href="#" title="Register">My Account(S Provider)</a>
                    <ul class="drop-down one-column hover-fade">
                        <li><a href="<?php echo e(route('sprovider.dashboard')); ?>">Dasboard</a></li>
                        <li><a href="<?php echo e(route('logout')); ?>"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                        </li>
                    </ul>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-container">
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav">
                        <li class="nav-item  d-none d-lg-block"><a href="<?php echo e(route('admin.contacts')); ?>"
    ...
    <!-- Navbar (Header) Ends-->
<?php /**PATH C:\Users\cws\Documents\Master Laravel Project\Total-Services\resources\views///////layouts/admin/header.blade.php ENDPATH**/ ?>