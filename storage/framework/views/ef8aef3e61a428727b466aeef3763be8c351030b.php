                            ...
                            <div class="panel-body">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td style="text-align:right;"><?php echo e($paytm->user_name); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left">User Number </td>
                                        <td style="text-align:right;"><?php echo e($paytm->user_phone); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left">Payment ID </td>
                                        <td style="text-align:right;"><?php echo e($paytm->order_id); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left">Paid Amount</td>
                                        <td style="text-align:right;"><?php echo e($paytm->price); ?></td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: left">Payment Status</td>
                                        <td style="text-align:right;"><?php echo e($paytm->status); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:right; word-wrap: break-word;">
                                            <?php echo e($paytm->transaction_id); ?></td>
                                    </tr>
                                </table>
                            </div>
...
<?php /**PATH C:\Users\cws\Documents\Master Laravel Project\Total-Services\resources\views/paytm/payment-success.blade.php ENDPATH**/ ?>