...
<div data-active-color="white" data-background-color="black"
    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true"
                ...
                <li class=" nav-item"><a href="<?php echo e(route('customer.dashboard')); ?>" class="font-weight-bold"><i
    ...
    <!-- Navbar (Header) Ends-->
<?php /**PATH C:\Users\cws\Documents\Master Laravel Project\Total-Services\resources\views////layouts/customer/header.blade.php ENDPATH**/ ?>