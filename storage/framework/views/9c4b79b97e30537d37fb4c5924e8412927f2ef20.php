<div>
    ...
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('app-assets/img/ico/favicon.ico')); ?>">
        <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('app-assets/img/ico/favicon-32.png')); ?>">
        ...
        <link rel="stylesheet" type="text/css"
            href="<?php echo e(asset('app-assets/fonts/font-awesome/css/font-awesome.min.css')); ?>">
    ...
    <body data-col="2-columns" class=" 2-columns  layout-dark">
        ...
        <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a
            ...
            <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a"
                ...
                <div class="cz-bg-image row sb-bg-img">
                    <div class="col-sm-2 mb-3"><img src="<?php echo e(asset('app-assets/img/sidebar-bg/01.jpg')); ?>" width="90"
                            class="rounded sb-bg-01">
                    </div>
                    <div class="col-sm-2 mb-3"><img src="<?php echo e(asset('app-assets/img/sidebar-bg/02.jpg')); ?>" width="90"
                            class="rounded sb-bg-02">
                    </div>
                    <div class="col-sm-2 mb-3"><img src="<?php echo e(asset('app-assets/img/sidebar-bg/03.jpg')); ?>" width="90"
                            class="rounded sb-bg-03">
                    </div>
                    <div class="col-sm-2 mb-3"><img src="<?php echo e(asset('app-assets/img/sidebar-bg/04.jpg')); ?>" width="90"
                            class="rounded sb-bg-04">
                    </div>
                    <div class="col-sm-2 mb-3"><img src="<?php echo e(asset('app-assets/img/sidebar-bg/05.jpg')); ?>" width="90"
                            class="rounded sb-bg-05">
                    </div>
                    <div class="col-sm-2 mb-3"><img src="<?php echo e(asset('app-assets/img/sidebar-bg/06.jpg')); ?>" width="90"
                ...
                <div class="tl-bg-img d-none">
                    ...
                    <div class="cz-tl-bg-image row">
                        <div class="col-sm-3"><img src="<?php echo e(asset('app-assets/img/gallery/bg-glass-1.jpg')); ?>"
                                width="90" class="rounded bg-glass-1 selected"></div>
                        <div class="col-sm-3"><img src="<?php echo e(asset('app-assets/img/gallery/bg-glass-2.jpg')); ?>"
                                width="90" class="rounded bg-glass-2">
                        </div>
                        <div class="col-sm-3"><img src="<?php echo e(asset('app-assets/img/gallery/bg-glass-3.jpg')); ?>"
                                width="90" class="rounded bg-glass-3">
                        </div>
                        <div class="col-sm-3"><img src="<?php echo e(asset('app-assets/img/gallery/bg-glass-4.jpg')); ?>"
        ...
        <script src="<?php echo e(asset('app-assets/vendors/js/chartist.min.js')); ?>" type="text/javascript"></script>
        <!-- END PAGE VENDOR JS-->
        <!-- BEGIN APEX JS-->
...
<?php /**PATH C:\Users\cws\Documents\Master Laravel Project\Total-Services\resources\views/frontend/layouts/guest.blade.php ENDPATH**/ ?>