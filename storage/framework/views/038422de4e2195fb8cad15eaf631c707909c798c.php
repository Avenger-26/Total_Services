...
<script type="text/javascript" src="<?php echo e(url('assets/js/nav/jquery.sticky.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/totop/jquery.ui.totop.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/rs-plugin/js/jquery.themepunch.tools.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/rs-plugin/js/jquery.themepunch.revolution.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/fancybox/jquery.fancybox.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/carousel/carousel.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/filters/jquery.isotope.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/twitter/jquery.tweet.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/flickr/jflickrfeed.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/bootstrap/bootstrap.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/dtb/jquery.table2excel.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/select2.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/bootstrap3-typeahead.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/main.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/slick.min.js')); ?>"></script>

<script type="text/javascript" src="<?php echo e(url('assets/js/owl.carousel.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(url('assets/js/purecounter.js')); ?>"></script>
...
<?php /**PATH C:\Users\cws\Documents\Master Laravel Project\Total-Services\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>