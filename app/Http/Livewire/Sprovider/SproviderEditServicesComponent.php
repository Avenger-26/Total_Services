...
class SproviderEditServicesComponent extends Component
{
    use WithFileUploads;
    public $name;
    public $slug;
    ...
    public function render()
    {
        ...
        return view('livewire.sprovider.sprovider-edit-services-component',['categories'=>$categories])->layout('frontend.layouts.guest');
    }
}
